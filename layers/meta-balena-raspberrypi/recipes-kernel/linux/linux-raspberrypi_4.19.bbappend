...
CMDLINE += "${@bb.utils.contains('DISTRO_FEATURES','osdev-image',"console=tty1 console=serial0,115200","console=null quiet splash vt.global_cursor_default=0 consoleblank=0",d)}"
CMDLINE_DEBUG = ""
